        ...
        <div className="flex min-h-full items-center justify-center p-4 sm:p-10">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3 relative group col-span-1 md:col-span-2">
                  <label className="text-[12px] font-black text-slate-300 tracking-[0.3em] ml-4 block drop-shadow-sm">New Password <span className="text-slate-600 normal-case font-medium">(leave blank to keep current)</span></label>
